      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#EEC951" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td style="border-right: 6px solid #D7A625;">
              <p><b><?php print t('Your order was canceled because no full payment has been made.' ); ?></b></p>
              <p><?php print t('For a refund, please contact us by phone (405) 606-7003'); ?></p>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              ...
              ?>
                ...
                <tr>
                    <td nowrap="nowrap">
                        <b><?php print t('Total payed')?>:</b>
                    </td>
                    <td>
                        <b><?php print fnl_store_format_amount(-$total_payed_and_payed_in_progress); ?></b>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td nowrap="nowrap">
                        <?php echo t('Amount Due for this Order:'); ?>
                    </td>
                    <td>
                        <?php echo fnl_store_format_amount($payment_left); ?>
                    </td>
                </tr>
                <tr>
                    <td nowrap="nowrap">
