        ...
        <div class="site-container">
          ...
          <div class="content-inner">
            <div class="view-content">
              <p>Oklahoma Children's Theatre is proudly located on the campus of Oklahoma City University, located along
                NW 23rd Street, between Pennsylvania Ave. and Classen Blvd.</p>

              <p class="strong">The Oklahoma Children's Theatre main office is located upstairs in the Children Center for the Arts
                (CCA) building on the corner of 25th and Blackwelder.</p>

              <p>We also stage productions in the Children Center for the Arts theatre, as well as in the Burg Theatre,
                and the Kirkpatrick Theatre, both of which are located in the main university Kirkpatrick Fine Arts
                Center, located across the road from our main building. Please refer to the <a href="#"
                                                                                               class="production">
                  Productions page</a> for
                specific theatre information.</p>

              <div class="page-page-img">
                <img src="theme/images/tmp/ocu-title.png" alt="">
