...
<body class="page page-page page-artists">
          ...
          <div class="b-subscribe">
            ...
            <div class="b-subscribe-field">
              <div id="mc_embed_signup">
                <form action="//oklahomachildrenstheatre.us9.list-manage.com/subscribe/post?u=ccf807fb860604bfaaccd4da6&amp;id=70c766ed1c" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate="">
        ...
        <div class="site-container">
          ...
          <div class="content-inner">
            ...
            <div class="view-content">
              <div class="pull-left">
                <img src="theme/images/tmp/mollie-face.jpg" alt="">
              </div>
              <div class="pull-right">
                <h5>Miss Mollie</h5>
                <p>
                FAVORITE FOOD IS…</p>
                <p>Root Beer Floats...(That counts as a food... Right?)</p>
                <p>FAVORITE MOVIE IS…</p>
                <p>A tie between "Enchanted" and "Up"!</p>
                <p>THE MOST FUN THING I HAVE EVER DONE…</p>
                <p>To go scuba diving in the Great Barrier Reef!</p>
                <p>What do sheep do on sunny days?</p>
                <p>Have a baa - baa - cue!
                </p>
              </div>
            </div>
            ...
            <div class="view-content">
              <div class="pull-left">
                <img src="theme/images/tmp/lyn.jpg" alt="">
              </div>
              <div class="pull-right">
                <h5>Miss Lyn</h5>
                <p>FAVORITE FOOD IS…</p>
                <p>a vegimite sandwich.</p>
                <p>FAVORITE MOVIE IS…</p>
                <p>"Men In Black"</p>
                <p>THE MOST FUN THING I HAVE EVER DONE…</p>
                <p>to start working with Children's Theatre 25 years ago!!!!!!</p>
                <p>Knock knock...Who's There?.....Boo....Boo who?.....</p>
                <p> Well, if you are going to cry I wont tell you!</p>
              </div>
            </div>
          </div>
        </div>
